...
<div className="side-nav w-[20%] bg-sky-100">
    ...
    <div className="btn flex flex-col items-center w-[60%] gap-5    ">
        <button className="flex justify-start items-center bg-slate-700 text-white p-2 w-full text-sm  rounded-lg gap-4"><svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"/>
</svg> Home</button>



        <button className="flex justify-start items-center  bg-white p-2 w-full text-sm  rounded-lg gap-4"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
 ...
 My Accounts </button>
    ...
    <div className="premium p-2 bg-yellow-100 flex flex-col gap-7 rounded-lg mb-6">
        <img className="h-44 w-44" src="/premium.png" alt="premi"></img>
